...
Taken from https://github.com/MrLixm/AgX.
Please refer to https://github.com/MrLixm/AgXc/issues/29 for license
of this file.
"""
__all__ = ("applyAgX",)
__version__ = "1.1.0"
...
def applyAgX(array):
    ...
    Args:
        array: float32 array, R-G-B-(A) format, sRGB Display
    """
    # Split the alpha out as we dont want to tonemap it.
    alpha = None
    if array.shape[-1] == 4:
        alpha = array[:,:,3:]
        array = array[:,:,:3]
    ...
    array = applyLookPunchy(array=array, punchy_gamma=1.2, punchy_saturation=1)
    # Ready for display.
